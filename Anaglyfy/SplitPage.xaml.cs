...
namespace Anaglyfy
{
    ...
    public sealed partial class SplitPage : Page
    {
        ...
        private async void bitmpe(lab01biometria.image_as_tab obiekt)
        {
            ...
            this.zdj.Source = writeableBitmap;
        ...
        private void navigationHelper_SaveState(object sender, SaveStateEventArgs e)//strzalka powrotu
        {
        ...
        private void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            var selectedItem = (Data.SampleDataItem)this.itemsViewSource.View.CurrentItem;
            lab01biometria.Visitor visitLeft=null;
            lab01biometria.Visitor visitRight=null;
            try


            {
                switch (selectedItem.UniqueId)
                {
                    case "1":
                        visitLeft = new TrueAnaglyphsLeft();
                        visitRight = new TrueAnaglyphsRight();
                ...
                visitLeft.rob(App.ImageLeft);
                visitRight.rob(App.ImageLeft);
                visitLeft.
